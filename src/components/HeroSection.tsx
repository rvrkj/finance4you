    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        <p className="font-body text-primary-foreground/70 text-lg md:text-xl max-w-2xl mx-auto mb-8 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
          6+ years of stock market education & investment awareness. 
          Helping you build discipline, confidence & independent decision-making.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
          ...
          <a href="#contact" className="border border-secondary/40 text-primary-foreground font-body px-8 py-3 rounded-lg hover:bg-secondary/10 transition-colors">
            Get in Touch
          </a>
        </div>
      </div>
